...
<div style="padding: 5px; position: absolute; z-index: 3; top: 10%; left: 5%;">

    <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data"
          action="${pageContext.request.contextPath}/point/addPoint.action"
        ...
        <div class="form-group form-inline">
            <label class="col-md-3" style="color:white">标题：</label> <input type="text" name="title"
                                                                           ...
                                                                           placeholder="title" value="${point.title}">
        </div>
        ...
        <div class="form-group form-inline">
            ...
            <input type="text" name="longitude" id="longitude" class="form-control" readonly="readonly"
                   placeholder="在地图上点击" value="${point.longitude}"/>
        </div>
        <div class="form-group form-inline">
            ...
            <input type="text" name="latitude" id="latitude" class="form-control" readonly="readonly"
                   placeholder="在地图上点击" value="${point.latitude}"/>
        </div>
        <div class="form-group form-inline">
