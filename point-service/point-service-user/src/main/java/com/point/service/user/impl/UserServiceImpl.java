...
public class UserServiceImpl implements UserService {
	...
	public Map<String, Object> modifyHeadPicture(HttpSession httpSession, String headpicture) {
		...
		File newFile = new File(path + "file"+System.getProperty("file.separator")+"user"+System.getProperty("file.separator")+"headpicture"+System.getProperty("file.separator") + newFileName);
				//new File(path + "file\\user\\headpicture\\" + newFileName);
